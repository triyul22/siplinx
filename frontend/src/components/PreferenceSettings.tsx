    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">{t("lang.label")}</h3>
            <p className="text-sm text-gray-600">Русский / English</p>
          </div>
          <select
            value={lang}
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">{t("settings.preferences.notifications")}</h3>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">{t("settings.preferences.dataStorageLocations")}</h3>
        <p className="text-sm text-gray-600 mb-6">
          {t("settings.preferences.dataStorageLocations.description")}
        </p>
        ...
        <div className="space-y-4">
          ...
          {/* Recordings Location */}
          <div className="p-4 border rounded-lg bg-gray-50">
            <div className="font-medium mb-2">{t("settings.preferences.meetingRecordings")}</div>
            <div className="text-sm text-gray-600 mb-3 break-all font-mono text-xs">
              {storageLocations?.recordings || t("settings.preferences.loadingDots")}
            </div>
            <button
            ...
            >
              <FolderOpen className="w-4 h-4" />
              {t("settings.preferences.openFolder")}
            </button>
          </div>
        </div>
        ...
        <div className="mt-4 p-3 bg-blue-50 rounded-md">
          <p className="text-xs text-blue-800">
            <strong>{t("settings.note")}</strong> {t("settings.preferences.storageNote")}
          </p>
        </div>
      </div>
