...
export function TranscriptPanel({
  ...
  return (
    <div ref={transcriptContainerRef} className="w-full border-r border-gray-200 bg-white flex flex-col overflow-y-auto">
      ...
      {!isRecording && <div className="sticky top-0 z-10 bg-white p-4 border-gray-200">
      ...
      {/* Transcript content */}
      <div className={isRecording ? "flex-1 bg-[#faf9f7] pb-28 pt-10 opacity-75" : "pb-20"}>
