...
#[command]
pub async fn init_analytics<R: tauri::Runtime>(app: tauri::AppHandle<R>) -> Result<(), String> {
    let config = AnalyticsConfig {
        api_key: "phc_qnmK7KqRbUvbZy3R4YBjWnZ2RrDTWmhHzW4CFSpdJjMt".to_string(),
        host: Some("https://eu.i.posthog.com".to_string()),
        enabled: true,
        // Real version from tauri.conf.json (Cargo.toml is stuck at 0.3.0)
